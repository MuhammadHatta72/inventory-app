                    ...
                    <form action="{{ route('customers.update', $customer) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="province" id="province" value="{{ old('province', $customer->province) }}" 
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="village" id="village" value="{{ old('village', $customer->village) }}" 
